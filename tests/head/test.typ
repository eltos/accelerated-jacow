...
#for group-by-affiliation in (true, false) [
  ...
  #show: jacow.with(
    ...
    authors: (
      (at: "CERN", 
       names: ("C. Petit-Jean-Genaz", "T. Baron", "R. Billen", "P. Ferreira", "N. Juszka", "M. Kołodziejski", "A. Mönnich", "P. Poulopoulou", "M. Vidal", )),
      ...
      (at:"Budker Institute of Nuclear Physics, 630090 Novosibirsk, Russia",
       names: ("M. V. Kuzin", )),
      (at: (if group-by-affiliation {", "} else {""}) + "Centre d’Etudes Nucléaires de Bordeaux Gradignan,\nUniversité de Bordeaux/IN2P3/CNRS, 33175 Gradignan, France",
       names: ("L. Serani", )),
      ...
      (at:"Fermilab, Batavia IL 60510, USA",
       names: ("M. Arena", )),
      ...
      (at:"Hong Kong University of Science and Technology, Hong Kong, P. R. China",
       names: ("Y.-Y Li", )),
      (at:"INFN-LNS, 95123 Catania, Italy",
       names: ("P. Pisciotta", )),
      ...
      (at:"Pohang Accelerator Laboratory, Gyeongbuk, Korea",
       names: ("D.-E. Kim", "G.-H. Kim", "K.-S. Kim", "N.-Y. Kim", "E.-H. Lee", )),
      ...
      (at:"TRIUMF, Vancouver, BC V6T 2A3, Canada",
       names: ("J. Thomson", )),
